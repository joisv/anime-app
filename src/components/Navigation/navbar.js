  ...
  return (
    <nav>
      <div className="w-full flex items-center p-5 justify-between">
            ...
            <svg width="26px" height="26px" className="fill-white" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" >
        ...
        <div className="flex w-24 items-center justify-between">
          <Link href='/search'> 
                <svg width="26px" height="26px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="white" strokeWidth="0.048">
            ...
            <svg width="19" height="25" viewBox="0 0 19 28" fill="none" xmlns="http://www.w3.org/2000/svg">
